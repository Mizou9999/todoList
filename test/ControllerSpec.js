...
describe("controller", function() {
	...
	it("should show entries on start-up", function() {
		...
		// add first test to show entries
	...
	describe("toggle all", function() {
		it("should toggle all todos to completed", function() {
			// TODO: write test
			let todo = [
				{ title: "my todo", id: 55, completed: false },
				{ title: "my todo 2", id: 22, completed: false }
			]
			setUpModel(todo)
			subject.setView("")
		...
		it("should update the view", function() {
			// TODO: write test
			let todo = [{ title: "my todo", id: 55, completed: true }]
			setUpModel(todo)
			subject.setView("")
			view.trigger("toggleAll", { completed: true })
	...
	describe("new todo", function() {
		it("should add a new todo to the model", function() {
			setUpModel([])
			subject.setView("")
			view.trigger("newTodo", "new todoList")
